        ...
        <div className="py-20">
            <Container>
                <div className="flex justify-between items-center">
                    ...
                    <BaseButton text={'Browse all'} size="sm" variant="ghost" rightIcon={<IoArrowForward />} />
                </div>
                {/* cards */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-5 lg:gap-6 mt-14">
